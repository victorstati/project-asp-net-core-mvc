...
using ProjectSaleMVC.Models.Enums;

namespace ProjectSaleMVC.Data
{
    public class SeedingService
    {
        private ProjectSaleMVCContext _context;
        ...
        public void Seed()
        {
            //Any() verifica se já tem algum dado na tabela do DB
            ...
            Seller s1 = new Seller(1, "Ben Brown", "ben@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Mary Green", "mary@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            ...
            Seller s5 = new Seller(5, "Donald Blue", "don@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Black", "aleb@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 9, 25), 11000.0, Models.Enums.SaleStatus.Billed, s1);
            ...
            //AddRange permite adicionar vários objetos de uma só vez
